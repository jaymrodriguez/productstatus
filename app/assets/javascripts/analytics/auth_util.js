 ...
 */
var clientId = '49727137637.apps.googleusercontent.com';
var apiKey = 'AIzaSyB9qvIVLADIU7AzG_5FHtyp5i8wR6EXeB4';
...
function handleAuthorized() {
  ...
  var k12Button = document.getElementById('k12-button');
  var collegeButton = document.getElementById('college-button');
  var mbaButton = document.getElementById('mba-button');
  var tutoringButton = document.getElementById('tutoring-button');

	authorizeButton.style.visibility = 'hidden';
	refreshButton.style.visibility = '';
	refreshButton.onclick = refreshData;
	homepageButton.onclick = pullHomepageLanding;
	k12Button.onclick = pullk12Landing;
	collegeButton.onclick = pullCollegeLanding;
	refreshData();
...
function handleUnauthorized() {
  var authorizeButton = document.getElementById('authorize-button');
  var refreshButton = document.getElementById('run-demo-button');
